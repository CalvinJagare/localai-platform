  ...
  return (
    <div className="p-8 max-w-2xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        ...
        {!creating && (
          <button
            onClick={() => { setCreating(true); setNewColor(COLORS[profiles.length % COLORS.length]) }}
                ...
                {editingId === p.id ? (
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="flex-1 bg-gray-800 border border-gray-600 rounded-lg px-2 py-1 text-sm text-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                    />
                    <button
